...
description: "Locus v0.5.7-mauvenightshade.1 (2026-07-13)"
sidebarTitle: "Latest Version"
version: "0.5.7-mauvenightshade.1"
...
- [Windows x64](https://github.com/MauveNightshade/Locus/releases/download/v0.5.7-mauvenightshade.1/locus_0.5.7-mauvenightshade.1_x64-setup.exe)
- [Windows x64 (system Python/Git)](https://github.com/MauveNightshade/Locus/releases/download/v0.5.7-mauvenightshade.1/locus_0.5.7-mauvenightshade.1_x64-without_embed_python_git-setup.exe)
- [GitHub Releases](https://github.com/MauveNightshade/Locus/releases)

## Changes

### v0.5.7-mauvenightshade.1 (Added)

- **Runtime UI scaling.** Added an adjustable interface scale setting for high-resolution displays.
- **Unity test dashboard.** Added test execution, result reporting, and diagnostics for Unity integration validation.

### v0.5.7-mauvenightshade.1 (Fixed)

- Fixed sidebar width jumps while dragging on the Session, Test, and Plugin views at high UI scales.
